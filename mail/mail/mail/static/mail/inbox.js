...
function displayEmails(emails, mailbox) {
  ...
  emails.forEach(email => {
    ...
    emailDiv.classList.add("row", "email-div");
    ...
    archiveDiv.classList.add("col-4");
    
    let archiveButton = document.createElement("input");
    archiveButton.type = "button";
    archiveButton.value = "Archive";
    archiveButton.id = "hide";
    archiveButton.classList.add("btn", "btn-sm", "btn-secondary", "float-right");
    ...
    archiveButton.onclick = function (event) {
      ...
      if (element.id === 'hide') {
        ...
        element.parentNode.parentNode.addEventList;
        setTimeout(rmv, 2500);
      } 
    };
